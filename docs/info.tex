...
\etitlefirst{ High-Performance Distributed Memory }
\etitlesecond{ Transfer Using RDMA }

% 中文标题
\ctitle{基于远程直接内存访问的高性能内存传输优化}
\etitle{ High-Performance Distributed Memory Transfer Using RDMA }
