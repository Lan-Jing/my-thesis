...
\cabstract{
    ...
    上述场景所产生的快速增长的计算需求，正在使计算集群的性能愈发捉襟见肘：一方面，高性能计算（HPC）集群正在得到更广泛的部署和应用。这类集群所拥有的新型高性能网络，明显地区别于传统集群。
    ...
    Ray是一种面向强化学习等任务的新型计算框架，但同样存在着上述性能挑战。为此，通过设计高效、高性能的通信机制，我们能将现代网络的硬件优势转化为Ray系统整体的性能优势。
